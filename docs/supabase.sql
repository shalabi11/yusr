...
CREATE TABLE public.automation_outbox (
  ...
  CONSTRAINT automation_outbox_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.prayer_time_snapshots (
  ...
  CONSTRAINT prayer_time_snapshots_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.user_khatma_plans (
  ...
  CONSTRAINT user_khatma_plans_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
...
CREATE TABLE public.user_reminders_legacy (
  ...
  CONSTRAINT user_reminders_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.profiles(id)
);
