              ...
              SliverPadding(
                ...
                sliver: SliverGrid(
                  ...
                  delegate: SliverChildListDelegate([
                    ServiceCard(title: AppStrings.quran.tr, icon: Icons.menu_book, route: '/quran'),
                    ServiceCard(title: AppStrings.adhkar.tr, icon: Icons.auto_awesome, route: '/adhkar'),
                    ServiceCard(title: AppStrings.reminders.tr, icon: Icons.notifications_active, route: '/reminders'),
                    ServiceCard(title: AppStrings.prayerTimes.tr, icon: Icons.access_time, route: '/prayer'),
                  ]),
                ),
              ),
